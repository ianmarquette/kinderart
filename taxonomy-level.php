...
<div id="content">
	...
	<div id="main" class="large-8 medium-8 columns first" role="main" data-equalizer>

			<h1 class="archive-title"><span><?php _e("Posts Categorized:", "jointstheme"); ?></span> <?php single_cat_title(); ?></h1>
				...
				<div class="large-6 medium-6 columns">
					<div class="panel" data-equalizer-watch>
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class(''); ?> role="article">
							...
							<section class="featured-image catrgory-image" itemprop="articleBody">
							<p>poop</p>
